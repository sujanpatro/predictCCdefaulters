...
class File_Operation:
    ...
    def save_model(self, model, filename):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occured in save_model method of the Model_Finder class. %s' % e)
            self.logger_object.log(self.file_object,
    ...
    def find_correct_model_file(self, cluster_number):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occurred in find_correct_model_file method of the Model_Finder class. %s' % e)
            self.logger_object.log(self.file_object,
